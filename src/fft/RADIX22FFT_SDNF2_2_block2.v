// -------------------------------------------------------------
// 
// File Name: C:\Users\jwbie\OneDrive\Documents\Academics\F22\551\551_Final_Project\fft_v2\hdl\joe_fft\RADIX22FFT_SDNF2_2_block2.v
...
module RADIX22FFT_SDNF2_2_block2
  ...
  input   signed [17:0] dout_1_4_re;  // sfix18
  input   signed [17:0] dout_1_4_im;  // sfix18
  input   signed [17:0] dout_1_8_re;  // sfix18
  input   signed [17:0] dout_1_8_im;  // sfix18
  input   dout_1_1_vld;
  output  signed [18:0] dout_7_re;  // sfix19
  output  signed [18:0] dout_7_im;  // sfix19
  output  signed [18:0] dout_8_re;  // sfix19
  output  signed [18:0] dout_8_im;  // sfix19
  ...
  reg signed [18:0] dout_7_re_1;  // sfix19
  reg signed [18:0] dout_7_im_1;  // sfix19
  reg signed [18:0] dout_8_re_1;  // sfix19
  reg signed [18:0] dout_8_im_1;  // sfix19
  reg  dout_2_vld;
  ...
  assign din1_re = {dout_1_4_re[17], dout_1_4_re};



  assign din1_im = {dout_1_4_im[17], dout_1_4_im};



  assign din2_re = {dout_1_8_re[17], dout_1_8_re};



  assign din2_im = {dout_1_8_im[17], dout_1_8_im};
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
    ...
    dout_7_re_1 = Radix22ButterflyG2_NF_btf1_re_reg[18:0];
    dout_7_im_1 = Radix22ButterflyG2_NF_btf1_im_reg[18:0];
    dout_8_re_1 = Radix22ButterflyG2_NF_btf2_re_reg[18:0];
    dout_8_im_1 = Radix22ButterflyG2_NF_btf2_im_reg[18:0];
