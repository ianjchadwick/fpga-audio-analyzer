// -------------------------------------------------------------
// 
// File Name: C:\Users\jwbie\OneDrive\Documents\Academics\F22\551\551_Final_Project\fft_v2\hdl\joe_fft\TWDLMULT_SDNF1_3_block1.v
...
module TWDLMULT_SDNF1_3_block1
  ...
  input   reset;
  input   enb_1_8_0;
  input   signed [18:0] dout_2_re;  // sfix19
  input   signed [18:0] dout_2_im;  // sfix19
  input   signed [18:0] dout_4_re;  // sfix19
  input   signed [18:0] dout_4_im;  // sfix19
  input   dout_2_vld;
  input   signed [16:0] twdl_3_6_re;  // sfix17_En15
  input   signed [16:0] twdl_3_6_im;  // sfix17_En15
  output  signed [19:0] twdlXdin_5_re;  // sfix20
  output  signed [19:0] twdlXdin_5_im;  // sfix20
  ...
  assign din_re = {dout_2_re[18], dout_2_re};
  ...
  assign twdlXdin_5_re = din1_re_dly9;

  assign din_im = {dout_2_im[18], dout_2_im};
  ...
  assign twdlXdin_5_im = din1_im_dly9;

  assign din_re_1 = {dout_4_re[18], dout_4_re};
  ...
  assign din_im_1 = {dout_4_im[18], dout_4_im};
  ...
  Complex4Multiply_block2 u_MUL4_2 (.clk(clk),
                                    .reset(reset),
                                    .enb_1_8_0(enb_1_8_0),
