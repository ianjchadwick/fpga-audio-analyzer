// -------------------------------------------------------------
// 
// File Name: C:\Users\jwbie\OneDrive\Documents\Academics\F22\551\551_Final_Project\fft_v2\hdl\joe_fft\RADIX22FFT_bitNatural_2.v
...
// Source Path: joe_fft/FFT/RADIX22FFT_bitNatural_2
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module RADIX22FFT_bitNatural_2
  ...
  input   dout_4_vld;
  output  signed [20:0] dMem_im2;  // sfix21
  ...
  reg signed [20:0] dMem_re2_1;  // sfix21
  reg signed [20:0] dMem_im2_1;  // sfix21
  reg  dMem_vld2;
  reg  startOutW;
  reg  endOutW;
  ...
  always @(posedge clk or posedge reset)
    begin : rdAddrGenBitNaturalP_process
      if (reset == 1'b1) begin
        ...
        rdAddrGenBitNaturalP_FFTIdxO <= 4'b0001;
