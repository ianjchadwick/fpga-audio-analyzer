// -------------------------------------------------------------
// 
// File Name: C:\Users\jwbie\OneDrive\Documents\Academics\F22\551\551_Final_Project\fft_v2\hdl\joe_fft\RADIX22FFT_bitNaturalMux_6.v
...
// Source Path: joe_fft/FFT/RADIX22FFT_bitNaturalMux_6
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module RADIX22FFT_bitNaturalMux_6
  ...
  input   dMem_vld1;
  output  signed [20:0] dMux_im6;  // sfix21
  ...
  reg signed [20:0] dMux_im6_1;  // sfix21
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_20_process
      if (reset == 1'b1) begin
        dMux_im6_1 <= 21'sb000000000000000000000;
      end
      else begin
