// -------------------------------------------------------------
// 
// File Name: C:\Users\jwbie\OneDrive\Documents\Academics\F22\551\551_Final_Project\fft_v2\hdl\joe_fft\RADIX22FFT_SDNF2_2_block1.v
...
module RADIX22FFT_SDNF2_2_block1
  ...
  input   signed [17:0] dout_1_3_re;  // sfix18
  input   signed [17:0] dout_1_3_im;  // sfix18
  input   signed [17:0] dout_1_7_re;  // sfix18
  input   signed [17:0] dout_1_7_im;  // sfix18
  input   dout_1_1_vld;
  output  signed [18:0] dout_5_re;  // sfix19
  output  signed [18:0] dout_5_im;  // sfix19
  output  signed [18:0] dout_6_re;  // sfix19
  output  signed [18:0] dout_6_im;  // sfix19
  ...
  reg signed [18:0] dout_5_re_1;  // sfix19
  reg signed [18:0] dout_5_im_1;  // sfix19
  reg signed [18:0] dout_6_re_1;  // sfix19
  reg signed [18:0] dout_6_im_1;  // sfix19
  reg  dout_2_vld;
  ...
  assign din1_re = {dout_1_3_re[17], dout_1_3_re};



  assign din1_im = {dout_1_3_im[17], dout_1_3_im};



  assign din2_re = {dout_1_7_re[17], dout_1_7_re};



  assign din2_im = {dout_1_7_im[17], dout_1_7_im};
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
    ...
    dout_5_re_1 = Radix22ButterflyG2_NF_btf1_re_reg[18:0];
    dout_5_im_1 = Radix22ButterflyG2_NF_btf1_im_reg[18:0];
    dout_6_re_1 = Radix22ButterflyG2_NF_btf2_re_reg[18:0];
    dout_6_im_1 = Radix22ButterflyG2_NF_btf2_im_reg[18:0];
