// -------------------------------------------------------------
// 
// File Name: C:\Users\jwbie\OneDrive\Documents\Academics\F22\551\551_Final_Project\fft_v2\hdl\joe_fft\RADIX22FFT_SDF1_1_block.v
...
module RADIX22FFT_SDF1_1_block
  ...
  input   reset;
  input   enb_1_8_0;
  input   signed [16:0] din_1_2_re_dly;  // sfix17
  input   signed [16:0] din_1_2_im_dly;  // sfix17
  input   din_1_vld_dly;
  input   rd_1_Addr;
  input   rd_1_Enb;
  input   proc_1_enb;
  output  signed [17:0] dout_1_2_re;  // sfix18
  output  signed [17:0] dout_1_2_im;  // sfix18
  ...
  assign din_re = {din_1_2_re_dly[16], din_1_2_re_dly};
  ...
  assign din_im = {din_1_2_im_dly[16], din_1_2_im_dly};
