// -------------------------------------------------------------
// 
// File Name: C:\Users\jwbie\OneDrive\Documents\Academics\F22\551\551_Final_Project\fft_v2\hdl\joe_fft\RADIX22FFT_bitNatural_7.v
...
// Source Path: joe_fft/FFT/RADIX22FFT_bitNatural_7
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module RADIX22FFT_bitNatural_7
  ...
  input   dout_4_vld;
  output  signed [20:0] dMem_im7;  // sfix21
  ...
  reg signed [20:0] dMem_re7_1;  // sfix21
  reg signed [20:0] dMem_im7_1;  // sfix21
  reg  dMem_vld7;
  reg  startOutW;
  reg  endOutW;
  ...
  always @(posedge clk or posedge reset)
    begin : rdAddrGenBitNaturalP_process
      if (reset == 1'b1) begin
        ...
        rdAddrGenBitNaturalP_FFTIdxO <= 4'b0110;
