// -------------------------------------------------------------
// 
// File Name: C:\Users\jwbie\OneDrive\Documents\Academics\F22\551\551_Final_Project\fft_v2\hdl\joe_fft\HDL_FIFO.v
...
// 
// Module: HDL_FIFO
// Source Path: joe_fft/fifo_1/HDL_FIFO
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HDL_FIFO
  ...
  assign fifo_out4 = fifo_sample_count == 4'b1010;
  ...
  assign fifo_front_indx_temp = (fifo_read_enable ? fifo_front_indx + fifo_front_dir :
              fifo_front_indx);
  assign fifo_front_dir_next = (fifo_front_indx_temp == 4'b1001 ? 4'b0111 :
              4'b0001);
  assign fifo_back_indx_temp = (fifo_write_enable ? fifo_back_indx + fifo_back_dir :
              fifo_back_indx);
  assign fifo_back_dir_next = (fifo_back_indx_temp == 4'b1001 ? 4'b0111 :
              4'b0001);
  ...
  SimpleDualPortRAM_generic #(.AddrWidth(4),
                            ...
                            u_HDL_FIFO_ram_generic (.clk(clk),
                                                    .enb(enb),
                                                    .wr_din(In),
                                                    .wr_addr(w_waddr),
                                                    .wr_en(w_we),  // ufix1
